     ...
     <div class="container">
          <div class="row">
               ...
               <div class="breadcumb-thumb">
                    <img src=" {{ (new App\Helpers\GeneralHelper())->fetchImageUrl($blog_data['bc_image']) ?? '' }}" alt="img">
               </div>            
               </div>
          </div>
     </div>
                    ...
                    @foreach($posts as $post)
                         ...
                         <div class="blog-single-card">
                              ...
                              <div class="blog-content">
                                   ...
                                   <a href="{{ url('/blog/'.$post['slug']) }}" class="btn style-border2"> READ MORE <i class="fas fa-arrow-right"></i></a>
                                   <div class="blog-date">
                                        <a href="{{ url('/blog/'.$post['slug']) }}"><span>{{ date('d', strtotime($post['date'])) }}</span>{{ date('M', strtotime($post['date'])) }}</a>
                                   </div>
