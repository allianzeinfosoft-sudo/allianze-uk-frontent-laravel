        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-lg-block d-none">
                <div class="breadcumb-thumb">
                    <img src="{{ (new App\Helpers\GeneralHelper())->fetchImageUrl($contact_data['bc_image']) ?? '' }}"
                        alt="img">
                </div>
            </div>
        </div>
        ...
        <div class="row gy-4 justify-content-center">
            ...
            <div class="col-xxl-4 col-lg-4 col-md-6">
                <div class="contact-info">
                    ...
                    <p class="contact-info_text"><a href="tel:{{ $company_info['phone'] }}">{{ $company_info['phone']
                            }}</a></p>
                    {{-- <p class="contact-info_text"><a href="tel:{{ $company_info['mobile'] }}">{{
                            $company_info['mobile'] }}</a></p> --}}
                </div>
            </div>
            <div class="col-xxl-4 col-lg-4 col-md-6">
                <div class="contact-info">
                    ...
                    <p class="contact-info_text"><a href="mailto:{{ $company_info['e-mail'] }}">{{
                            $company_info['e-mail'] }}</a></p>
                    <p class="contact-info_text"><a
                            href="mailto:info@allianzeinfosoft.co.uk">info@allianzeinfosoft.co.uk</a></p>
                    <p class="contact-info_text"><a href="{{ $company_info['website'] }}">{{ $company_info['website']
                            }}</a></p>
                </div>
            </div>
        </div>
...
<div class="space-bottom">
    <div class="container">
        <div class="map-sec">
            <iframe
                src="{{ $company_info['google_map_link'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.7310056272386!2d89.2286059153658!3d24.00527418490799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe9b97badc6151%3A0x30b048c9fb2129bc!2s!5e0!3m2!1sen!2sbd!4v1651028958211!5m2!1sen!2sbd' }}"
                ...
                <div class="faq-thumb2 mb-xl-0 mb-50">
                    <div class="about-counter-grid jump">
                        ...
                        <div class="media-right">
                            <h3 class="about-counter"><span class="counter-number">{{ $contact_data['about_counter'] ??
                                    ''}}</span>+</h3>
                            <h4 class="about-counter-text">{{ $contact_data['about_counter_text'] ?? ''}}</h4>
                        </div>
                    </div>
                    <img src="{{ (new App\Helpers\GeneralHelper())->fetchImageUrl($contact_data['about_counter_image']) ?? asset('assets/img/normal/faq-thumb-2-1.png') }}"
                        alt="img">
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <form action="{{ route('contact-us.submit') }}" method="POST" class="appointment-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select name="subject" class="form-select" required>
                                        ...
                                        <option value="Engineering Documentation Services">Engineering Documentation
                                            Services</option>
                                        ...
                                        <option value="Market Research and Financial Services">Market Research and
                                            Financial Services</option>
                                        <option value="Real Estate Image Editing Service">Real Estate Image Editing
                                            Service</option>
                                        <option value="Scanning and Indexing Services">Scanning and Indexing Services
                                        </option>
                                        ...
                                        <option value="Wedding Image Editing Services">Wedding Image Editing Services
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-12">
                                <textarea name="message" class="form-control" placeholder="Message here.."
                                    required></textarea>
                            </div>
    ...
    <div class="footer-top-1 bg-dark" style="background-image: url({{asset('assets/img/bg/footer-top-bg1-1.png')}});">
        <div class="footer-logo">
            <a href="index.html"><img
                    src="{{(new App\Helpers\GeneralHelper())->fetchImageUrl($company_info['company_logo']) ?? asset('assets/img/logo-white.svg') }}"
                    alt="Fixturbo"></a>
        </div>
        <div class="call-media-wrap">
            ...
            <div class="media-body">
                ...
                <h4 class="link">
                    <a class="text-white" href="tel:{{ $company_info['mobile'] ?? '' }}">{{ $company_info['mobile'] ??
                        '' }}</a>
                </h4>
            </div>
        </div>
